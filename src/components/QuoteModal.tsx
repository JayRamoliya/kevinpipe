...
import { X, CheckCircle, Send, PhoneCall, Building2, User, Mail, MessageSquare, Package } from 'lucide-react';
        ...
        {submitted ? (
          <div className="text-center py-6 sm:py-8">
            ...
            <p className="text-sm text-gray-600 max-w-md mx-auto leading-relaxed mb-6">
              Thank you, <strong className="text-gray-900">{formData.fullName || 'Valued Partner'}</strong>. Our technical sales engineering team at Kevin PVC Pipe Industries has received your inquiry for <strong className="text-[#071B4A]">{formData.productInterest}</strong> and will contact you within 2 business hours.
            </p>
            <div className="p-4 bg-[#F3F6F8] rounded-2xl text-xs sm:text-sm text-gray-600 mb-6 text-left space-y-1.5">
              <div><strong>Direct Desk:</strong> 02791-291353</div>
              <div><strong>Email:</strong> info@kevinpvcpipe.com</div>
              <div><strong>Plant:</strong> Untvad, Babra, Dist. Amreli, Gujarat</div>
            </div>
            <button
              type="button"
              onClick={handleReset}
          ...
          <div>
            <div className="mb-5 sm:mb-6 pr-8">
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-1">
                Provide your requirements below. Direct pricing with verified test certifications.
              </p>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="Custom Specification / Fittings">Fittings & Accessories</option>
                    </select>
                  </div>
                </div>
