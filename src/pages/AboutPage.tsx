      ...
      <section className="bg-[#071B4A] text-white py-16 lg:py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="mt-4 text-base sm:text-lg text-sky-100/80 max-w-2xl mx-auto font-light leading-relaxed">
            Pioneering precision polymer extrusion, high-tensile column piping, and agricultural irrigation infrastructure for over two decades.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            ...
            {/* On mobile, stack image cleanly or text first then image */}
            {/* Image (Visible on mobile below text or above) */}
            <div className="lg:col-span-5 order-2 lg:order-2">
              <div className="relative rounded-card overflow-hidden border border-gray-100 soft-shadow p-2 bg-[#F3F6F8]">
                ...
                <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 bg-[#071B4A]/90 backdrop-blur-md p-3.5 sm:p-4 rounded-2xl text-white border border-white/10">
                  <p className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-[#08A9D6]">Automated Facility</p>
                  <p className="text-xs sm:text-xs text-white/90">Fully automated German twin-screw extrusion line</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-5 sm:space-y-6 order-1 lg:order-1">
              <span className="text-xs font-bold uppercase tracking-widest text-[#08A9D6] block font-heading">
                Our Story & Operational Legacy
              </span>
              <h2 className="text-[26px] sm:text-3xl lg:text-4xl font-extrabold text-[#071B4A] font-heading tracking-tight leading-tight">
                Building Water Lifelines With Unyielding Manufacturing Discipline
              </h2>

              <p className="text-base text-gray-700 leading-relaxed font-normal">
                <strong>KEVIN PVC PIPE INDUSTRIES</strong> was established on the conviction that water delivery systems must never be compromised by material fatigue, joint leakage, or chemical degradation. Situated strategically along the <em>Rajkot-Bhavnagar Highway in Amreli District, Gujarat</em>, our modern manufacturing complex spans over 100,000 square feet of high-capacity production space.
              </p>

              <p className="text-base text-gray-700 leading-relaxed font-normal">
                We manufacture an all-encompassing portfolio of piping systems: <strong>uPVC Pressure Pipes</strong> for municipal and potable water conveyance, <strong>uPVC Column Pipes</strong> engineered for deep submersible borewell extraction, <strong>uPVC Casing & Screen Pipes</strong> for groundwater recharge, and <strong>HDPE Pipes & Sprinklers</strong> powering modern micro-irrigation agriculture.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div className="p-4 sm:p-5 rounded-2xl bg-[#F3F6F8] border border-gray-100">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 leading-relaxed font-normal">
                    To deliver zero-defect, hydrostatically superior piping solutions that empower farmers, municipalities, and industries to conserve water and cut pumping costs.
                  </p>
                </div>
                ...
                <div className="p-4 sm:p-5 rounded-2xl bg-[#F3F6F8] border border-gray-100">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 leading-relaxed font-normal">
                    Continuous multi-line extrusion capacity exceeding 24,000 metric tons annually, backed by automated material batching and 100% online quality control.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-card border border-gray-100 soft-shadow p-6 sm:p-10 lg:p-12 w-full max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-center">
              ...
              <div className="md:col-span-8 space-y-4 border-t md:border-t-0 md:border-l border-gray-100 md:pl-8 pt-6 md:pt-0">
                <span className="text-3xl text-[#08A9D6] font-serif leading-none">“</span>
                <p className="text-base text-gray-700 italic leading-relaxed font-normal">
                  When a farmer installs a column pipe in a 1,000-foot borewell, or a municipal board installs a drinking water mainline under a highway, they place their absolute trust in our engineering. We refuse to compromise that trust with cheaper recycled fillers or rushed curing. Every meter of pipe bearing the KEVIN name is built to endure fifty years of unbroken service.
                </p>
                
                <div className="pt-2 text-xs sm:text-sm text-gray-600 space-y-1">
                  <p><strong>Executive Office:</strong> Kevin PVC Pipe Industries Headquarters</p>
                  <p><strong>Philosophy:</strong> Continuous R&D, Transparent Business Ethics, and Farmer-First Pricing.</p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
            ...
            <p className="text-gray-600 mt-2 text-base leading-relaxed font-normal">
              Every production batch adheres strictly to the rigorous test protocols defined by the Bureau of Indian Standards (BIS) and ISO regulatory frameworks.
            </p>
          </div>
      ...
      <section className="py-14 sm:py-20 bg-[#F3F6F8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
            ...
            <p className="text-gray-600 mt-2 text-base leading-relaxed font-normal">
              Major government bodies and public water authorities rely on Kevin PVC Pipes for regional pipeline projects, rural tap-water schemes, and irrigation networks.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            ...
            <div className="bg-white rounded-card p-6 sm:p-8 border border-gray-100 soft-shadow text-center flex flex-col items-center">
              ...
              <h3 className="text-lg font-bold text-[#071B4A] font-heading">WASMO</h3>
              <p className="text-xs text-gray-500 mt-1 font-medium">Water and Sanitation Management Organisation</p>
              <p className="text-sm text-gray-600 mt-3 leading-relaxed font-normal">
                Registered and approved vendor supplying high-durability uPVC potable water distribution networks across rural villages under statewide community water supply programs.
              </p>
            ...
            <div className="bg-white rounded-card p-6 sm:p-8 border border-gray-100 soft-shadow text-center flex flex-col items-center">
              ...
              <h3 className="text-lg font-bold text-[#071B4A] font-heading">GWSSB</h3>
              <p className="text-xs text-gray-500 mt-1 font-medium">Gujarat Water Supply and Sewerage Board</p>
              <p className="text-sm text-gray-600 mt-3 leading-relaxed font-normal">
                Empaneled contractor vendor providing heavy-duty pressure pipes and HDPE lines for large-scale municipal pipelines, bulk transmission mains, and urban drainage networks.
              </p>
              <span className="mt-4 px-3 py-1 rounded-full text-[11px] font-bold bg-sky-50 text-[#08A9D6] border border-sky-100">
            ...
            <div className="bg-white rounded-card p-6 sm:p-8 border border-gray-100 soft-shadow text-center flex flex-col items-center sm:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-lg font-bold text-[#071B4A] font-heading">GIRDA</h3>
              <p className="text-xs text-gray-500 mt-1 font-medium">Gujarat Industrial Research & Development Agency</p>
              <p className="text-sm text-gray-600 mt-3 leading-relaxed font-normal">
                Regularly audited and endorsed by GIRDA scientific labs for hydrostatic resilience, mechanical elongation, impact test compliance, and polymer chemical purity.
              </p>
              <span className="mt-4 px-3 py-1 rounded-full text-[11px] font-bold bg-sky-50 text-[#08A9D6] border border-sky-100">
      ...
      <section className="py-14 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
            ...
            <p className="text-gray-600 mt-2 text-base leading-relaxed font-normal">
              Kevin PVC Pipe Industries is officially recognized and registered by premier regulatory authorities and agricultural subsidy programs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
            ...
            <div className="rounded-card border-2 border-sky-100 bg-[#F0F9FD] p-6 sm:p-8 soft-shadow relative flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold text-[#071B4A] font-heading">WASMO Approved</h3>
                <p className="text-xs font-medium text-[#08A9D6] mt-1">Water and Sanitation Management Organisation</p>
                <p className="text-sm text-gray-600 mt-3 leading-relaxed font-normal">
                  Authorized for supply under Village Water Supply Schemes, Jal Jeevan Mission, and Gujarat Rural Water Supply projects.
                </p>
              </div>
            ...
            <div className="rounded-card border-2 border-sky-100 bg-[#F0F9FD] p-6 sm:p-8 soft-shadow relative flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold text-[#071B4A] font-heading">GWSSB Approved</h3>
                <p className="text-xs font-medium text-[#08A9D6] mt-1">Gujarat Water Supply & Sewerage Board</p>
                <p className="text-sm text-gray-600 mt-3 leading-relaxed font-normal">
                  Qualified and registered for heavy infrastructure pipelines, lift irrigation works, and municipal bulk water conduits.
                </p>
              </div>
              <div className="mt-6 pt-4 border-t border-sky-200/50 flex items-center justify-between text-xs text-[#071B4A] font-bold">
            ...
            <div className="rounded-card border-2 border-sky-100 bg-[#F0F9FD] p-6 sm:p-8 soft-shadow relative flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl font-bold text-[#071B4A] font-heading">I-Khedut Approved</h3>
                <p className="text-xs font-medium text-[#08A9D6] mt-1">Department of Agriculture, Govt. of Gujarat</p>
                <p className="text-sm text-gray-600 mt-3 leading-relaxed font-normal">
                  Registered portal vendor for government farmer subsidies on Sprinkler Piping Sets, HDPE irrigation, and deep-well column pipes.
                </p>
              </div>
              <div className="mt-6 pt-4 border-t border-sky-200/50 flex items-center justify-between text-xs text-[#071B4A] font-bold">
